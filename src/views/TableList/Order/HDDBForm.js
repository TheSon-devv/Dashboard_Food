...
import { Grid, TextField, withStyles, Button, MenuItem, FormControl, InputLabel, Select } from "@material-ui/core";
...
const HDDBForm = ({ classes, ...props }) => {
    ...
    const validate = (fieldValues = values) => {
        ...
        if ("priceHDDB" in fieldValues)
            temp.priceHDDB = fieldValues.priceHDDB ? "" : "Vui lòng điền giá trị hóa đơn";
...
export default connect(mapStateToProps, mapActionToProps)(withStyles(styles)(HDDBForm));